...
export class ScriptParserUtils {
  public static parseFile = (file: File): Promise<ParsedInstruction[]> => {
  ...
  public static executeInstruction = async (instruction: ParsedInstruction) => {
  ...
  public static highlightKeywords = (line: string) => {
